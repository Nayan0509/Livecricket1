  ...
  return (
    ...
    >
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
        ...
        {!isLive && !isCompleted && (
           <span style={{ fontSize: 10, color: "#38BDF8", fontWeight: 700, background: "rgba(56,189,248,0.12)", padding: "4px 10px", borderRadius: 100 }}>UPCOMING</span>
        )}
      </div>
        ...
        <div style={{
          ...
          {match.score.map((s, i) => (
            <div key={i} style={{
              ...
              <span style={{ fontWeight: 900, fontSize: 16, color: isLive ? "#3B82F6" : "var(--text)", fontFamily: "Roboto, sans-serif" }}>
                {s.r}/{s.w}
