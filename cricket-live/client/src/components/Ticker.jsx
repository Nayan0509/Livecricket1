...
function MatchChip({ match, onClick }) {
  ...
  return (
    ...
    >
      ...
      {match.status && (
        <span style={{
          fontSize: 9, fontWeight: 700, color: "rgba(59,130,246,0.8)",
          maxWidth: 100, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap",
          borderLeft: "1px solid rgba(59,130,246,0.2)", paddingLeft: 8,
        }}>
          {match.status}
        </span>
      )}
  ...
  if (!matches.length) {
    return (
      <div style={{
        ...
        <span style={{ fontSize: 9, fontWeight: 800, letterSpacing: "1.5px", textTransform: "uppercase", color: "#3B82F6", background: "rgba(59,130,246,0.12)", padding: "3px 10px", borderRadius: 100, flexShrink: 0 }}>
          LIVE FEED
        </span>
