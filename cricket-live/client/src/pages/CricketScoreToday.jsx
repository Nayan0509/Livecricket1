    ...
    <div style={{ maxWidth: 960, margin: "0 auto", padding: "0 16px 60px" }}>
      ...
      <div style={{
        ...
        <h1 style={{ fontSize: 26, fontWeight: 900, color: "var(--text)", margin: "0 0 6px" }}>
          Cricket Score <span style={{ color: "#22C55E" }}>Today</span>
        </h1>
                ...
                >
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                    <div>
                      ...
                      <div style={{ fontSize: 11, color: "#4ADE80", fontWeight: 600 }}>{m.status}</div>
                      {m.venue && <div style={{ fontSize: 11, color: "var(--text3)", marginTop: 2 }}>📍 {m.venue}</div>}
                    </div>
                    <span style={{ fontSize: 12, fontWeight: 700, color: "#22C55E", background: "rgba(34,197,94,0.1)", border: "1px solid rgba(34,197,94,0.25)", padding: "5px 13px", borderRadius: 20, whiteSpace: "nowrap" }}>
                      Live Score →
                    </span>
                  </div>
                </div>
        ...
        <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
          {[
            ...
            <Link key={to} to={to} style={{
              ...
              onMouseEnter={e => { e.currentTarget.style.background = "rgba(34,197,94,0.08)"; e.currentTarget.style.color = "#22C55E"; e.currentTarget.style.borderColor = "rgba(34,197,94,0.25)"; }}
