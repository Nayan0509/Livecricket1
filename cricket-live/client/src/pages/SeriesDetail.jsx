    ...
    <div style={{ maxWidth: 960, margin: "0 auto", padding: "0 16px 60px" }}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", gap: 12, flexWrap: "wrap" }}>
          ...
          {upcoming.length > 0 && (
            <span style={{ fontSize: 11, fontWeight: 700, padding: "3px 11px", borderRadius: 20, background: "rgba(245,158,11,0.08)", border: "1px solid rgba(245,158,11,0.18)", color: "#F59E0B" }}>
      ...
      {(tab === "schedule" || TABS.length === 0) && (
        <div>
          ...
          {upcoming.length > 0 && (
            <section style={{ marginBottom: 24 }}>
              <h2 style={{ fontSize: 14, fontWeight: 800, color: "#F59E0B", marginBottom: 12 }}>📅 Upcoming</h2>
              <MatchList matches={upcoming} accent="#F59E0B" />
            </section>
          )}
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 12 }}>
              <div style={{ minWidth: 0 }}>
                ...
                {m.status && m.matchEnded && (
                  <div style={{ fontSize: 11, color: "#4ade80", marginTop: 2, fontWeight: 600 }}>{m.status}</div>
                )}
              </div>
              <span style={{
