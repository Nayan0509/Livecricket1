...
export default function ODICricket() {
  return (
    <TournamentPage
      ...
      seoDesc="ODI cricket live score today. Real-time One Day International match updates with ball-by-ball commentary. All ODI series and bilateral series covered."
