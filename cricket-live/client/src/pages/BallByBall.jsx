    ...
    <div style={{ maxWidth: 960, margin: "0 auto", padding: "0 16px 60px" }}>
      ...
      <div style={{
        ...
        <h1 style={{ fontSize: 28, fontWeight: 900, color: "var(--text)", margin: "0 0 8px" }}>
          Ball by Ball <span style={{ color: "#3B82F6" }}>Commentary</span>
        </h1>
        ...
        <div style={{ display: "flex", gap: 10, flexWrap: "wrap", marginTop: 14 }}>
          {["Every Ball", "Every Run", "Every Wicket", "15s Updates"].map(t => (
            <span key={t} style={{ fontSize: 11, fontWeight: 700, padding: "4px 12px", borderRadius: 20, background: "rgba(59,130,246,0.08)", border: "1px solid rgba(59,130,246,0.18)", color: "#3B82F6" }}>{t}</span>
          ))}
        </div>
      </div>
                ...
                {matches.map(m => (
                  ...
                  >
                    <div>
                      ...
                      <div style={{ fontSize: 12, color: "#60A5FA", fontWeight: 600 }}>{m.status}</div>
                    </div>
                    <span style={{ fontSize: 12, fontWeight: 700, color: "#3B82F6", background: "rgba(59,130,246,0.1)", border: "1px solid rgba(59,130,246,0.25)", padding: "6px 14px", borderRadius: 20, whiteSpace: "nowrap" }}>
                      Ball-by-Ball →
                    </span>
                  </div>
                ))}
      ...
      <section style={{ marginTop: 20, marginBottom: 20 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(200px, 1fr))", gap: 12 }}>
          {[
            ...
            { icon: "📺", title: "Official Highlights", desc: "Official post-match highlights alongside ball-by-ball text commentary" },
